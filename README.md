...
- [x] Complete Scotch.io's [tutorial on building a RESTful API with MEAN (minus Angular)](https://scotch.io/tutorials/build-a-restful-api-using-node-and-express-4)
- [x] Complete Scotch.io's [tutorial on building a simple Todo SPA with MEAN](https://scotch.io/tutorials/creating-a-single-page-todo-app-with-node-and-angular) (code is in todo-app folder above)
- [x] Complete Thinkster.io's [tutorial on building a two-page webapp with MEAN](https://thinkster.io/mean-stack-tutorial/) (finished everything but the passport authentication section at the end; code is in flapper-news folder above)
